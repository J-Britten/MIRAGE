...
public class BenchmarkManager : MonoBehaviour
{
    ...
    private void WriteSummaryToLog()
    {
        ...
        // Unity FPS stats
        File.AppendAllText(logFilePath, "UNITY FPS:\n");
        File.AppendAllText(logFilePath, $"Average: {fpsStats.average:F2}, Min: {fpsStats.min:F2}, Max: {fpsStats.max:F2}, StdDev: {fpsStats.stdDev:F2}\n");
    }
